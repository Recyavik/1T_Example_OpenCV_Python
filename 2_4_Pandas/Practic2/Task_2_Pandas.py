...
import pandas as pd
data = {'Имя': ['Таня', 'Андрей', None, 'Миша'],
        'Возраст': [25, None, 30, 35],
        'Город': ['Москва', 'Иркутск', 'Сочи', None]}
df = pd.DataFrame(data)
print(df.isnull())  # Возвращает DataFrame с булевыми значениями, указывающими на пропущенные данные
...
data = {'Имя': ['Таня', 'Андрей', None, 'Миша'],
        ...
        'Город': ['Москва', 'Иркутск', 'Сочи', None]}
df = pd.DataFrame(data)
df['Возраст'].fillna(df['Возраст'].mean(), inplace=True)  # Заполняет пропущенные данные средним значением столбца
...
# Группировка данных:
import pandas as pd
data = {'Город': ['Москва', 'Москва', 'Санкт-Петербург', 'Санкт-Петербург', 'Москва'],
...
data1 = {'Имя': ['Таня', 'Андрей', 'Миша'],
        'Возраст': [25, 30, 35]}
data2 = {'Имя': ['Таня', 'Андрей', 'Миша'],
        'Город': ['Москва', 'Иркутск', 'Сочи']}
